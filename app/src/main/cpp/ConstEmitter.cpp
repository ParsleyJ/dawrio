...
Java_com_parsleyj_dawrio_daw_elements_ConstEmitter_00024Companion_getValue(JNIEnv *env, jobject thiz,
                                                                  jlong handle) {
    return reinterpret_cast<ConstEmitter *>(handle)->getEmittedValue();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_parsleyj_dawrio_daw_elements_ConstEmitter_00024Companion_setValue(JNIEnv *env, jobject thiz,
                                                                         jlong handle, jfloat
                                                                         f) {
